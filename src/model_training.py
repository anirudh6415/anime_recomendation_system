...
class ModelTraining:
    def __init__(self,data_path):
        ...
        self.experiment = comet_ml.Experiment(
            api_key= "OZTzOIRmVQRbuOaffhsGL7KYL",
            project_name= "anime-recomendation-system",
            workspace= "anirudh6415"
        )
        logger.info("Model Training & CometML Intialized....")
    ...
    def load_data(self):
        try:
            ...
            logger.info("Data Loading successfully for model training....")
